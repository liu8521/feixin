...
<section id="page1" data-role="page">
  <header data-role="header"  data-theme="b" ><h1>CET成绩查询</h1></header>
  <div data-role="content" class="content">
  
        <form method="post" action="getCetScore" data-ajax="false">
             
            <div data-role="fieldcontain">
                <label for="cetno">准考证号（包括口试）：</label>
                <input type="text" name="number" id="cetno" placeholder="请输入准考证号">
                <br><br>
                
                <label for="name">姓名：</label>
                <input type="text" name="name" id="name" placeholder="您的姓名..." data-theme="c">
            </div>
            <br><br>
