...
<section id="page1" data-role="page">
  <header data-role="header"  data-theme="b" ><h1>绩点查询</h1></header>
  <div data-role="content" class="content" action="getCourse">
  
        <form method="post" id="loginform" action="getJidian" data-ajax="false">
             
            <div data-role="fieldcontain">
                <label for="sno">学号：</label>
                <input type="text" name="xh" id="sno" placeholder="请输入学号">
                <br><br>
            </div>
            <br><br>
